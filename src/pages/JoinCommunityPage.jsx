...
const JoinCommunityPage = () => {
  const telegramLink = "YOUR_TELEGRAM_CHANNEL_LINK_HERE"; // Replace with actual link
  const whatsappLink = "YOUR_WHATSAPP_GROUP_LINK_HERE"; // Replace with actual link
        ...
        <motion.div variants={fadeIn}>
          <Card className="shadow-xl border-primary/30 h-full glass-card">
            <CardHeader className="items-center text-center">
              <Send className="h-16 w-16 text-sky-500 mb-3" />
              <CardTitle className="text-3xl font-semibold text-foreground">Telegram Channel</CardTitle>
              <CardDescription className="text-muted-foreground pt-1">
                Instant notifications, broad reach, and organized content.
              </CardDescription>
            </CardHeader>
            <CardContent className="text-center">
              <p className="mb-6 text-foreground/90">
                Join our Telegram channel for daily job alerts, important announcements, and links to valuable resources. Perfect for quick updates on the go.
              </p>
              <Button 
                size="lg" 
                className="w-full md:w-auto bg-sky-500 hover:bg-sky-600 text-white text-lg py-3 px-8"
                asChild
              >
